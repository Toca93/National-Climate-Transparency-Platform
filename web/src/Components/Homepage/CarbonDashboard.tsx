  ...
  return (
    <div className="carbon-dashboard">
      <div className="dashboard-container">
            ...
            <div className="stats-container" ref={statsRef}>
              <div className="stats-wrapper">
                <div className="main-statistic procount">
                  ...
                  <div className="statistic-title">{t('homepage:totprojects')}</div>
                </div>
                <div className="main-statistic">
                  <div className={`statistic-value ${isAnimating ? 'counting' : ''}`}>
                    {creditCount.toLocaleString()}
                  </div>
                  <div className="statistic-title">{t('homepage:totcredits')}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="section">
          <h3 className="section-title">{t('homepage:distributionbystatus')}</h3>
          <motion.div
            ...
            {creditData.map((item, index) => (
              <div key={index} className="credit-card">
                <div className="credit-statistic">
                  <div className="credit-value">{item.value.toLocaleString()}</div>
