...
const MRVEmissions = () => {
  ...
  const columns = [
    { title: 'ID', width: 100, dataIndex: 'id', key: 'id', sorter: false },
    { title: 'Emission Source', width: 200, dataIndex: 'source', key: 'source', sorter: false },
    { title: 'Sector', width: 150, dataIndex: 'sector', key: 'sector', sorter: false },
    { title: 'Amount (tCO2e)', width: 150, dataIndex: 'amount', key: 'amount', sorter: false },
  ...
  return (
    <div className="content-container">
      <div className="title-bar">
        <div className="body-title">MRV Emissions</div>
      </div>
        ...
        <Row>
          <Col span={24}>
            <LayoutTable
              ...
              emptyMessage="No MRV Emissions Available"
            />
          </Col>
        </Row>
      </div>
