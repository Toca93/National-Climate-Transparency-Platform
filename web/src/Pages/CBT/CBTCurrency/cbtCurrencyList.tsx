...
const CBTCurrencyList = () => {
  ...
  const columns = [
    ...
    {
      title: 'Napomena o metodologiji',
      width: 250,
      dataIndex: 'methodologyNote',
      key: 'methodologyNote',
      sorter: false,
    },
  ];
  ...
  return (
    <div className="content-container">
      <div className="title-bar">
        <div className="body-title">Klimatsko finansiranje - Valuta i metodologija</div>
      </div>
        ...
        <Row>
          <Col span={24}>
            <LayoutTable
              ...
              emptyMessage="Nema dostupnih zapisa valute i metodologije"
            />
          </Col>
        </Row>
      </div>
...
export default CBTCurrencyList;
