...
const Verifications = () => {
  ...
  const columns = [
    { title: 'Verification ID', width: 120, dataIndex: 'id', key: 'id', sorter: false },
    { title: 'Entity', width: 200, dataIndex: 'entity', key: 'entity', sorter: false },
    { title: 'Type', width: 150, dataIndex: 'type', key: 'type', sorter: false },
    { title: 'Verifier', width: 150, dataIndex: 'verifier', key: 'verifier', sorter: false },
  ...
  return (
    <div className="content-container">
      <div className="title-bar">
        <div className="body-title">Verifications</div>
      </div>
        ...
        <Row>
          <Col span={24}>
            <LayoutTable
              ...
              emptyMessage="No Verifications Available"
            />
          </Col>
        </Row>
      </div>
