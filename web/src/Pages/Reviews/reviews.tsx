...
const Reviews = () => {
  ...
  const columns = [
    { title: 'Review ID', width: 100, dataIndex: 'id', key: 'id', sorter: false },
    { title: 'Subject', width: 200, dataIndex: 'subject', key: 'subject', sorter: false },
    { title: 'Reviewer', width: 150, dataIndex: 'reviewer', key: 'reviewer', sorter: false },
    { title: 'Review Date', width: 120, dataIndex: 'reviewDate', key: 'reviewDate', sorter: false },
    { title: 'Rating', width: 100, dataIndex: 'rating', key: 'rating', sorter: false },
  ...
  return (
    <div className="content-container">
      <div className="title-bar">
        <div className="body-title">Reviews</div>
      </div>
